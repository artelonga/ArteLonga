...
(function (global) {
    ...
    const people = [
        ...
        },
        {
          ...
          "pic": "/mono/mono.jpeg",
          "bio": "Atuo em formação na área de Segurança da Informação, com interesse no desenvolvimento de práticas que integrem proteção de dados, análise de vulnerabilidades e consciência organizacional. Minha trajetória combina estudo contínuo, curiosidade por tecnologia e sensibilidade humana, orientando minha forma de compreender riscos e construir soluções.\n\nTenho interesse amplo por tecnologia e busco constantemente aprender sobre diferentes áreas da TI, explorando desde fundamentos até novas ferramentas e tendências.\n\nSou natural de Brasília e, aos 16 anos, me mudei para a Bahia, em Ilhéus. Anos depois, decidi sair em busca de crescimento profissional e artístico, estabelecendo-me no Rio Grande do Sul, onde reconstruí minha trajetória conciliando trabalho e formação.\n\nNo campo artístico, desenvolvo minha carreira como ator, com formação construída ao longo de anos de estudo e prática. Integrei a companhia Teatro Luz & Cena, experiência que fortaleceu minha presença cênica e consolidou a arte como parte essencial da minha identidade. Posteriormente, segui para São Paulo, onde tive contato com a Arte Longa e o Quilombo Auracária, filosofias que ampliaram minha visão sobre criação, coletividade e propósito, influenciando diretamente minha forma de pensar e atuar tanto na arte quanto na vida profissional.\n\nFoi a partir de experiências reais com vulnerabilidades e golpes que encontrei na cibersegurança um novo propósito. Hoje, compreendo a segurança da informação não apenas como um campo técnico, mas como uma forma de proteger pessoas, relações e histórias. Acredito na integração entre áreas humanas e tecnológicas como um diferencial essencial para o presente e o futuro.\n",
          "servicos": [
            "Consultoria em TI",
        ...
        },
        {
          ...
          "pic": "/alice/alice.png",
          "bioAudio": "/alice/alice.ogg",
          "bioHidden": "...has recently been introduced to the measurement of weight and length and enjoys working with peers, weighing different objects using the scale and recording the weight of objects in her math note book. Alice places great effort into everything that she works on and always asks for questions that are challenging and exciting.",
          "bio": "*Culture* — This is Alice's favorite area in the classroom. She is very passionate about the world around her and has a real thirst for knowledge. She loves to do projects on all types of topics and she is organized and thorough in her information. This year she has also been introduced to the universe, as well the passage of time. Alice's interests are often heightened when she is able to make a model or display for the lovely projects which she completes and she is very proud of these accomplishments. Alice always participates in group discussions and she listens attentively questioning anything that she is not sure of. Alice is very interested in the world of around and she seems to have a very good understanding about how different things function and why. The few projects that she has completed are always interesting and informative. She is moving toward being more comfortable and confident when presenting to her peers.",
          "servicos": [
            "Pensamento Islâmico",
            "Dança e Expressão Corporal"
          ],
        ...
        },
        {
          ...
          "contacts": {
            "tagline": "Tortas salgadas artesanais. Faça seu pedido ⤵️"
          }
        },
        {
          "handle": "matheus",
        ...
        },
        {
          ...
          "emMemoria": true,
          "birthDate": "1965-06-01T12:00:00-03:00",
        ...
        {
          "handle": "retro-umarizal",
          "type": "business",
          "nome": "Retro Umarizal Burger & Chopp",
          "role": "Alimentação",
          "tags": [
            "parceiro",
            "alimentacao"
          ...
          "parcerias": [
            {
              ...
              "contribuicoes": [
                {
                  "quem": "yuri",
                  "oque": "Inteligência e Tecnologia · todos os subcomponentes (Desenvolvimento Web, API, Dados, Nuvem, Computação, Hardware, Redes, Sistemas, Software) + Tráfego e Crescimento"
                },
                {
                  "quem": "mono",
