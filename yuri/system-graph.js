  ...
  function dataModel() {
    var nodes = [
      ...
      { id: "ibusp", lp: "left", label: "IB-USP", title: "Instituto de Biociências — USP", cat: "organizacao", step: 0,
        desc: { "pt-BR": "IB-USP — Instituto de Biociências da USP: o meu primeiro nó, onde eu comecei. É daqui que sai a minha visualização de dados (figuras em R) publicada nos artigos.",
                "en": "IB-USP — University of São Paulo's Biosciences Institute: my first node, where I started. The source of my data visualization (R figures) published in the papers." } },
      { id: "butantan", lp: "left", label: "Butantan", title: "Instituto Butantan", cat: "organizacao", step: 1, url: "https://bv.fapesp.br/pt/bolsas/134702/origem-e-evolucao-das-serpentes-e-sua-diversificacao-na-regiao-neotropical/",
        desc: { "pt-BR": "Instituto Butantan (2012), onde fui bolsista FAPESP — meu primeiro cliente de dados: pesquisa de iniciação científica sobre a origem e evolução das serpentes na região Neotropical, com a orientadora Erika Hingst-Zaher. Aqui comecei a coleta de campo e laboratório.",
                "en": "Instituto Butantan (2012), where I was a FAPESP scholar — my first data client: an undergraduate research project on the origin and evolution of snakes across the Neotropics, advised by Erika Hingst-Zaher. This is where I began field and lab collection." } },
    ...
    var steps = [
      { year: { "pt-BR": "2012 — início", "en": "2012 — start" }, focus: "ibusp",
        ...
        body: { "pt-BR": "IB-USP, Instituto de Biociências da USP — onde eu comecei. É daqui que sai a minha visualização de dados (figuras em R) publicada nos artigos.",
                "en": "IB-USP, University of São Paulo's Biosciences Institute — where I started. The source of my data visualization (R figures) in the papers." } },
      { year: { "pt-BR": "2012 — FAPESP", "en": "2012 — FAPESP" }, focus: "butantan",
        title: { "pt-BR": "Instituto Butantan — coleta", "en": "Instituto Butantan — collection" },
        body: { "pt-BR": "Instituto Butantan, onde fui bolsista FAPESP (orientadora Erika Hingst-Zaher) — pesquisei a origem e evolução das serpentes na região Neotropical e coletei dados de campo e laboratório.",
                "en": "Instituto Butantan, where I was a FAPESP scholar (advised by Erika Hingst-Zaher) — I researched the origin and evolution of snakes across the Neotropics and collected field and lab data." } },
